...
A carefully curated, no bullshit collection of learning resources that I've personally used and genuinely recommend.
...
Never touched Linux? Never programmed? Want to learn networking? Here's a couple resources that'd certainly be useful to you in the early days. If you're new to IT, please don't skip this section.
...
It's hard to operate a computer without an operating system... This section will focus mainly on Windows and Linux since theses are the Operating Systems that I work on. Maybe I'll add Android and Apple stuff in the future.

### Linux 🐧<a name="linux"></a>
* 🆓📺 [**Linux for Hackers by NetworkChuck**](https://www.youtube.com/playlist?list=PLIhvC56v63IJIujb5cyE13oLuyORZpdkL)<br>
Free YouTube course/playlist that will get you through the basics of Linux with a lot of great humour and coffee 😉☕

* 🆓📜 [**Linux Roadmap**](https://roadmap.sh/linux)<br>
...
* 🆓📚 [**The Linux Command Line by William Shotts**](https://sourceforge.net/projects/linuxcommand/files/TLCL/24.11/TLCL-24.11.pdf/download)<br>
...
* 🆓📚 [**The Linux Commands Handbook by Flavio Copes**](https://flaviocopes.com/access/)<br>
...
* 💵📚 [**Windows Security Internals: A Deep Dive into Windows Authentication, Authorization, and Auditing by James Forshaw**](https://www.amazon.com/Windows-Security-Internals-Authentication-Authorization/dp/1718501986)<br>
...
* 💵📚 **Computer Networking: A Top-Down Approach by Kurose and Rose**<br>
...
Cisco Packet Tracer is a network simulation and visualization tool that allows users to design, configure, and troubleshoot virtual computer networks without requiring physical hardware. It is widely used by students, educators, and IT professionals to practice networking concepts, test configurations, and prepare for networking certifications.

***

## Cybersecurity 💻 <a name="cyber"></a>
It shouldn't come to you as a surprise that this section is going to be quite massive. I tried to divide it into a couple of subsection to make it easier to navigate and find whatever might be useful. Enjoy!

* 🆓📜 [**Cyber Security Roadmap**](https://roadmap.sh/cyber-security)<br>
...
* 🆓🌐 [**MITRE ATT&CK Matrix Poster**](https://attack.mitre.org/docs/attack_matrix_poster_2024_april.pdf)<br>
...
* 🆓🌐 [**Draw io**](https://www.drawio.com/)<br>
  Draw.io (also known as diagrams.net) is a free, web-based diagramming tool that enables users to create flowcharts, network diagrams, UML diagrams, ER diagrams, and other technical or business visualizations using a drag-and-drop interface. It is widely used by students, educators, IT professionals, and engineers to design, document, and share diagrams, with support for cloud storage, offline use, and multiple export formats.
...
* 🆓📝 [**Junior Cybersecurity Analyst Career Path by Cisco**](https://www.netacad.com/career-paths/cybersecurity?courseLang=en-US)<br>
  It's an awesome introductory series of courses that can get you a nice certificate. Also you can try to take Cisco Certified Support Technician (CCST) Cybersecurity exam afterwards but this one isn't free at the time of making this list.This course consists of 6 smaller courses with the final exam at the end. You can take each course individualy and get a smaller certification each time you complete it if you wish to. Here's a list of the courses mentioned: Introduction to Cybersecurity, Networking Basics, Networking Devices and Initial Configuration, Endpoint Security, Network Defense, Cyber Threat Management

* 💵📚🇵🇱 [**Bezpieczeństwo domowego routera Wi-Fi. Wprowadzenie by Adam Samson**](https://wydawnictwo.securitum.pl/bezpieczenstwo-domowego-routera-wifi)<br>
...
* 🆓🌐 [**OSINT Framework**](https://osintframework.com/) <br>
  A massive list of tools that would certainly be useful during OSINT research. If you're into OSINT then you've probably heard about it already, but it's still worth mentioning.

* 🆓🌐 [**TinEye**](https://tineye.com/) <br>
  Reverse Image Search tool available online. Search over 85 billion images and find where images appear online.

* 🆓🌐 [**WhatsMyName Web**](https://whatsmyname.app/) <br>
  A free tool that searches hundreds of websites and online platforms to identify where a specific username is in use, helping users map digital footprints. It is widely used by cybersecurity professionals, investigators, and researchers to locate public online profiles and gather publicly available information for investigations.

* 🆓🌐 [**SunCalc**](https://www.suncalc.org/) <br>
  SunCalc is a free web-based tool that visualizes the sun's position, sunrise and sunset times, shadow lengths, and other solar data for any location, date, and time.

* 🆓🌐 [**Google's Advanced Search**](https://www.google.com/advanced_search) <br>
  Google Advanced Search is a powerful search interface that helps users refine searches by filtering results using exact phrases, excluded words, languages, regions, file types, domains, and last update dates.

* 🆓🌐 [**Nitter**](https://nitter.net/) <br>
  Nitter is a free, open-source alternative frontend for X (formerly Twitter) that lets users browse public posts without ads, JavaScript tracking, or the need to log in. It is commonly used by privacy-conscious users, researchers, and OSINT investigators to anonymously view profiles, posts, media, and RSS feeds while reducing tracking by the official platform.
...
* 🆓🌐 [**APT1 Exposing One of China’s Cyber Espionage Units by Mandiant**](https://services.google.com/fh/files/misc/mandiant-apt1-report.pdf) <br>
...
* 💵📚🇵🇱 [**Era Cyberszpiegów**](https://wydawnictwo.securitum.pl/era-cyberszpiegow)<br>
  Krótko i na temat odnośnie największych zagrożeń w postaci APT. Książka skupia się na 4 państwach: Chinach, Rosji, Koreii Północnej i Iranie. Dobra pozycja start, nie polecam jeżeli zależy Tobie na bardziej szczegółowych informacjach.
...
## Programming 👨🏻‍💻 <a name="prog"></a>
This sections is also divided into a couple of subsections focusing on topic related to a specified programming language. Enjoy!

### Bash 🐌 <a name="progba"></a>
* 🆓📺 [**You need to learn BASH Scripting RIGHT NOW!!**](https://www.youtube.com/playlist?list=PLIhvC56v63IKioClkSNDjW7iz-6TFvLwS)<br>
  Free YouTube course/playlist that will get you through the basics of Bash scripting with some interesting exercises, great humour and a lot of coffee 😉☕. Probably the best place to start learning Bash!
...
* 🆓🌐 [**Learn C++**](https://www.learncpp.com/) <br>
  LearnCpp.com is a free website devoted to teaching you how to program in modern C++. Simple and easy explanations of difficult concepts :)

***
## Fun Stuff a.k.a. other resources 🎉 <a name="fun"></a>

* 💵📚 [**Humble Bundle**](https://www.humblebundle.com)<br>
...
*Disclaimer <br>
I don't own and I'm not associated with any of the provided resources. The entire content of this repository is meant for educational purposes only. If you encounter any issues feel free to contact me.*
